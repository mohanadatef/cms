...
@section('content')
    <section class="content-header">
        <h1>
            Album
            <small>All Album Delete</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin') }}"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="{{ url('/admin/album/index/delete') }}"><i class="fa fa-permissions"></i>Album Delete</a></li>
        </ol>
    </section>
...
@section('script_style')
    ...
    <script>
        function selectItem(slug) {
            $('#album_restore').attr('action', "../restore/"+slug);
        }
    </script>
@endsection