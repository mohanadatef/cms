...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/news/create') }}"><i class="fa fa-permsission"></i>Create News</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form  id ='news_create'  action="{{url('admin/news/store')}}" enctype="multipart/form-data" method="POST" >
                    {{csrf_field()}}
                    <div class="row">
    <div class="col-md-6">
...
@yield('script_description_language')
    {!! JsValidator::formRequest('Modules\MediaCenter\Http\Requests\admin\News\NewsCreateRequest','#news_create') !!}
@endsection