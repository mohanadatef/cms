...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/gallery/edit/'.$data->slug) }}"><i class="fa fa-permsission"></i>Edit
                    Gallery: {{$data->title_en }} / {{$data->title_ar}}</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3>Edit Gallery: {{$data->title_en }} / {{$data->title_ar}}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <form id="gallery_edit" action="{{url('admin/gallery/update/'.$data->slug)}}"
                    ...
                    <div align="center">
                        <img src="{{url('public/images/gallery').'/'.$data->image}}" style="width: 100px;height: 100px">
