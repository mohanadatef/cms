...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/home_slider/index/delete') }}"><i class="fa fa-permissions"></i>Home Slider Delete</a></li>
        </ol>
    </section>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($datas as $data)
                                <tr>
                                    ...
                                    @permission('home-slider-restore')
                                    <td align="center">
    ...
    <div class="modal modal-warning fade" id="modal-warning">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="home_slider_restore" action="" >
...
@section('script_style')
    ...
    <script>
        function selectItem(slug) {
            $('#home_slider_restore').attr('action', "../restore/"+slug);
        }
    </script>
@endsection