...
@section('content')
    <section class="content-header">
        <h1>
            Setting
            <small>Create Setting</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin') }}"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="{{ url('/admin/setting/index') }}"><i class="fa fa-permsissions"></i>Setting</a></li>
            <li><a href="{{ url('/admin/setting/create') }}"><i class="fa fa-permsission"></i>Create Setting</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form  id ='setting_create'  action="{{url('admin/setting/store')}}" enctype="multipart/form-data"  method="POST" >
                    {{csrf_field()}}
                    <div class="row">
    <div class="col-md-6">
...
@section('script_style')
    {!! JsValidator::formRequest('Modules\Setting\Http\Requests\admin\Setting\SettingCreateRequest','#setting_create') !!}
@endsection