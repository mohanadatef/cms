...
@section('content')
    <section class="content-header">
        <h1>
            About US
            <small>Create About US</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin') }}"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="{{ url('/admin/about_us/index') }}"><i class="fa fa-permsissions"></i>About US</a></li>
            <li><a href="{{ url('/admin/about_us/create') }}"><i class="fa fa-permsission"></i>Create About US</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form  id ='about_us_create'  action="{{url('admin/about_us/store')}}" enctype="multipart/form-data"  method="POST" >
                    {{csrf_field()}}
                    <div class="row">
    <div class="col-md-6">
...
@yield('script_description_language')
    {!! JsValidator::formRequest('Modules\Setting\Http\Requests\admin\About_Us\About_UsCreateRequest','#about_us_create') !!}
@endsection