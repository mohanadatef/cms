...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/about_us/index') }}"><i class="fa fa-permsissions"></i>About US</a></li>
            <li><a href="{{ url('/admin/about_us/edit/'.$data->slug) }}"><i class="fa fa-permsission"></i>Edit About US: {{$data->title_en }} / {{$data->title_ar}}</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3>Edit About US: {{$data->title_en }} / {{$data->title_ar}}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <form id="about_us_edit" action="{{url('admin/about_us/update/'.$data->slug)}}" enctype="multipart/form-data" method="POST">
                    {{csrf_field()}}
                    {{method_field('patch')}}
                    <div class="row">
    <div class="col-md-6">
    ...
    Order : <input type="text" value="{{$data->order}}" class="form-control" name="order" id="order" placeholder="Enter You Order">
                    ...
                    <div align="center">
                        <img src="{{url('public/images/about_us').'/'.$data->image}}" style="width: 100px;height: 100px">
...
@yield('script_description_language')
    {!! JsValidator::formRequest('Modules\Setting\Http\Requests\admin\About_Us\About_UsEditRequest','#about_us_create') !!}
@endsection