    ...
    <section class="content">
        <div class="box">
            <div class="box-header" align="right">
                ...
                <a href="{{  url('/admin/permission/create') }}" class="btn btn-primary">Create</a>
                @endpermission
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                        ...
                        @foreach($datas as $data)
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="{{ url('/admin/permission/edit/'.$data->slug)}}"><i
    ...
    <div class="modal modal-danger fade" id="modal-danger">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="permission_delete" action="" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                    <div class="modal-body">
                        <p>If you Delete it ,You will Delete Data in Role & User</p>
                    </div>
...
@section('script_style')
    ...
    <script>
        function selectItem(slug) {
            $('#permission_delete').attr('action', "destroy/"+slug);
        }
    </script>
@endsection