...
@section('content')
    <section class="content-header">
        <h1>
            Permission
            <small>All Permission Delete</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin') }}"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="{{ url('/admin/permission/index/delete') }}"><i class="fa fa-permissions"></i>Permission Delete</a></li>
        </ol>
    </section>
    ...
    <div class="modal modal-warning fade" id="modal-warning">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="premission_restore" action="" >
...
@section('script_style')
    ...
    <script>
        function selectItem(slug) {
            $('#premission_restore').attr('action', "../restore/"+slug);
        }
    </script>
@endsection