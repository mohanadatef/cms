...
@section('content')
    <section class="content-header">
        <h1>
            User
            <small>All User Delete</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin') }}"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="{{ url('/admin/user/index/delete') }}"><i class="fa fa-users"></i>User Delete</a></li>
        </ol>
    </section>
...
@section('script_style')
    ...
    <script>
        function selectItem(slug) {
            $('#user_restore').attr('action', "../restore/"+slug);
        }
    </script>
@endsection