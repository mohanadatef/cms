...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/size/index/delete') }}"><i class="fa fa-permissions"></i>Size Delete</a></li>
        </ol>
    </section>
...
@section('script_style')
    ...
    <script>
        function selectItem(slug) {
            $('#size_restore').attr('action', "../restore/"+slug);
        }
    </script>
@endsection