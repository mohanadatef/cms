...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/vacance/index/delete') }}"><i class="fa fa-permissions"></i>Vacance Delete</a></li>
        </ol>
    </section>
    ...
    <div class="modal modal-warning fade" id="modal-warning">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="vacance_restore" action="" method="get">
...
@section('script_style')
    ...
    <script>
        function selectItem(slug) {
            $('#vacance_restore').attr('action', "../restore/"+slug);
        }
    </script>
@endsection