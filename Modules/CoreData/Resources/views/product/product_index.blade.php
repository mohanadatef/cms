...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/product/index') }}"><i class="fa fa-permissions"></i>Product</a></li>
        </ol>
    </section>
    <section class="content">
        <form method="get" action="{{ url('/admin/product/change_many_status')}}">
            <div class="box">
                <div class="box-header" align="right">
                    ...
                    @endpermission
                    @permission('product-many-status')
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($datas as $data)
                                    <tr>
                                        ...
                                        <td align="center">
                                            @if($data->status ==1)
                                                <a href="{{ url('/admin/product/change_status/'.$data->slug)}}"><i
            ...
            <div class="modal-content">
                ...
                <form id='product_create' action="" method="POST">
                    <div class="modal-body">
                        ...
                        <h3 align="center">Product Create</h3>
                        <section class="content">
                            {{csrf_field()}}
    ...
    <div class="modal modal-info fade" id="modal-edit">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="product_edit" action="" method="POST">
                    <div class="modal-body">
...
@section('script_style')
    <script>
        $('#product_create').attr('action', "store");
        function selectItem(slug, title_en, title_ar, order) {
            $('#product_edit').attr('action', "update/" + slug);
            $('#title_en').val(title_en);
            $('#title_ar').val(title_ar);
            $('#order').val(order);
            $('#product_delete').attr('action', "destroy/"+slug);
        }
    </script>
    @include('includes.admin.scripts_datatable')
    {!! JsValidator::formRequest('Modules\CoreData\Http\Requests\admin\Product\ProductEditRequest','#product_create') !!}
    {!! JsValidator::formRequest('Modules\CoreData\Http\Requests\admin\Product\ProductStatusEditRequest','#status') !!}
