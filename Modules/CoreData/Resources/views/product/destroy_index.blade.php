...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/product/index/delete') }}"><i class="fa fa-permissions"></i>Product Delete</a></li>
        </ol>
    </section>
    ...
    <div class="modal modal-warning fade" id="modal-warning">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="product_restore" action="" >
...
@section('script_style')
    ...
    <script>
        function selectItem(slug) {
            $('#product_restore').attr('action', "../restore/"+slug);
        }
    </script>
@endsection