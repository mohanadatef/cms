...
@section('content')
    <section class="content-header">
        <h1>
            Category Service
            <small>All Category Service Delete</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin') }}"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="{{ url('/admin/category_service/index/delete') }}"><i class="fa fa-permissions"></i>Category Service Delete</a></li>
        </ol>
    </section>
    <section class="content">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    @else
                        <h3 align="center">There is no Data to show</h3>
                    @endif
                </div>
                <!-- /.box-body -->
            </div>
    ...
    <div class="modal modal-warning fade" id="modal-warning">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="category_service_restore" action="" >
...
@section('script_style')
    ...
    <script>
        function selectItem(slug) {
            $('#category_service_restore').attr('action', "../restore/"+slug);
        }
    </script>
@endsection