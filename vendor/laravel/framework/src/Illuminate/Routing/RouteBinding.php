...
{
    /**
     * Create a Route modal binding for a given callback.
     *
    ...
    /**
     * Create a Route modal binding for a modal.
     *
     * @param  \Illuminate\Container\Container  $container
     * @param  string  $class
    ...
    public static function forModel($container, $class, $callback = null)
    {
        return function ($value) use ($container, $class, $callback) {
            ...
            // For modal binders, we will attempt to retrieve the models using the first
            // method on the modal instance. If we cannot retrieve the models we'll
            ...
            // what we should do when the modal is not found. This just gives these
