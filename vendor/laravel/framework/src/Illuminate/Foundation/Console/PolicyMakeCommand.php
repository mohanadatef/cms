...
class PolicyMakeCommand extends GeneratorCommand
{
    ...
    protected function buildClass($name)
    {
        ...
        $model = $this->option('modal');

        return $model ? $this->replaceModel($stub, $model) : $stub;
    }

    /**
     * Replace the User modal namespace.
     *
     * @param  string  $stub
     * @return string
     */
    ...
    /**
     * Replace the modal for the given stub.
     *
     * @param  string  $stub
     * @param  string  $model
     * @return string
    ...
    protected function replaceModel($stub, $model)
    {
        ...
        $dummyModel = Str::camel($model) === 'user' ? 'modal' : $model;
    ...
    {
        return [
            ['modal', 'm', InputOption::VALUE_OPTIONAL, 'The modal that the policy applies to'],
        ];
    }
}
