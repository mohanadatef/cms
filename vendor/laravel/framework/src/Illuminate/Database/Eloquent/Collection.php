...
{
    /**
     * Find a modal in the collection by key.
     *
     * @param  mixed  $key
     * @param  mixed  $default
    ...
    /**
     * Reload a fresh modal instance from the database for all the entities.
     *
    ...
    public function getQueueableClass()
    {
        ...
        $this->each(function ($model) use ($class) {
            if (get_class($model) !== $class) {
                throw new LogicException('Queueing collections with multiple modal types is not supported.');
            }
        });
    ...
    public function getQueueableConnection()
    {
        ...
        $this->each(function ($model) use ($connection) {
            if ($model->getConnectionName() !== $connection) {
                throw new LogicException('Queueing collections with multiple modal connections is not supported.');
            }
        });
