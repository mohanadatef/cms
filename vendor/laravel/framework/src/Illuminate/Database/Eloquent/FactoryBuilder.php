...
class FactoryBuilder
{
    ...
    /**
     * The name of the modal being built.
     *
     * @var string
     */
    ...
    /**
     * The database connection on which the modal instance should be persisted.
     *
     * @var string
     */
    ...
    /**
     * The modal after making callbacks.
     *
     * @var array
     */
    ...
    /**
     * The modal after creating callbacks.
     *
     * @var array
     */
    ...
    /**
     * Set the state to be applied to the modal.
     *
     * @param  string  $state
     * @return $this
     */
    ...
    /**
     * Set the states to be applied to the modal.
     *
    ...
    /**
     * Set the database connection on which the modal instance should be persisted.
     *
     * @param  string  $name
     * @return $this
     */
    ...
    /**
     * Create a modal and persist it in the database if requested.
     *
    ...
    /**
     * Get a raw attributes array for the modal.
     *
     * @param  array  $attributes
     * @return mixed
     *
    ...
    /**
     * Make an instance of the modal with the given attributes.
     *
     * @param  array  $attributes
    ...
    /**
     * Apply the active states to the modal definition array.
     *
    ...
    /**
     * Call after callbacks for each modal and state.
     *
