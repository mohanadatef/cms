...
{
    /**
     * The modal definitions in the container.
     *
     * @var array
     */
    ...
    /**
     * Define a callback to run after making a modal.
     *
     * @param  string  $class
    ...
    /**
     * Define a callback to run after making a modal with given state.
     *
     * @param  string  $class
     * @param  string  $state
     * @param  callable  $callback
    ...
    /**
     * Define a callback to run after creating a modal.
     *
     * @param  string  $class
     * @param  callable  $callback
     * @param  string $name
    ...
    /**
     * Define a callback to run after creating a modal with given state.
     *
     * @param  string  $class
     * @param  string  $state
     * @param  callable  $callback
    ...
    /**
     * Create an instance of the given modal and persist it to the database.
     *
     * @param  string  $class
    ...
    /**
     * Create an instance of the given modal and type and persist it to the database.
     *
     * @param  string  $class
     * @param  string  $name
     * @param  array  $attributes
    ...
    /**
     * Create an instance of the given modal.
     *
     * @param  string  $class
     * @param  array  $attributes
     * @return mixed
    ...
    /**
     * Create an instance of the given modal and type.
     *
     * @param  string  $class
     * @param  string  $name
     * @param  array  $attributes
    ...
    /**
     * Get the raw attribute array for a given named modal.
     *
     * @param  string  $class
     * @param  string  $name
     * @param  array  $attributes
    ...
    /**
     * Get the raw attribute array for a given modal.
     *
     * @param  string  $class
     * @param  array  $attributes
     * @param  string  $name
    ...
    /**
     * Create a builder for the given modal.
     *
     * @param  string  $class
     * @param  string  $name
