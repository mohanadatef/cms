...
trait InteractsWithPivotTable
{
    ...
    /**
     * Toggles a modal (or models) from the parent.
     *
     * Each existing modal is detached, and non existing ones are attached.
     *
     * @param  mixed  $ids
     * @param  bool   $touch
     * @return array
    ...
    protected function attachNew(array $records, array $current, $touch = true)
    {
        ...
        foreach ($records as $id => $attributes) {
            ...
            // given to the method. If the modal is actually updated we will add it to the
    ...
    /**
     * Attach a modal to the parent using a custom class.
     *
     * @param  mixed  $id
     * @param  array  $attributes
     * @return void
    ...
    protected function baseAttachRecord($id, $timed)
    {
        ...
        // them by calling the parent modal's "freshTimestamp" method which will
        // provide us with a fresh timestamp in this modal's preferred format.
        if ($timed) {
    ...
    /**
     * Create a new existing pivot modal instance.
     *
     * @param  array  $attributes
     * @return \Illuminate\Database\Eloquent\Relations\Pivot
     */
