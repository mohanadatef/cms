...
class ScopeHelperTests extends TestCase
{
    ...
    /**
     * Test that primary slug is set to $modal->slugKeyName when set.
     */
    ...
    /**
     * Test primary slug is set to first defined slug if $modal->slugKeyName is not set.
     */
    ...
    /**
     * Test finding a modal by its primary slug.
     */
    ...
    /**
     * Test finding a modal by its primary slug fails if the slug does not exist.
     */
    ...
    /**
     * Test finding a modal by its primary slug throws an exception if the slug does not exist.
     *
