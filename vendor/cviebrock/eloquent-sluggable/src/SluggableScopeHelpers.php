 ...
 *
 * Helper trait for defining the primary slug of a modal
...
trait SluggableScopeHelpers
{
    ...
    /**
     * Primary slug column of this modal.
     *
     * @return string
     */
    ...
    /**
     * Primary slug value of this modal.
     *
     * @return string
     */
    ...
    /**
     * Query scope for finding a modal by its primary slug.
     *
    ...
    /**
     * Find a modal by its primary slug.
     *
     * @param string $slug
     * @param array $columns
    ...
    /**
     * Find a modal by its primary slug or throw an exception.
     *
     * @param string $slug
     * @param array $columns
