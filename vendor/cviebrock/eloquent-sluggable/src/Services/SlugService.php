...
class SlugService
{
    ...
    /**
     * Get the sluggable configuration for the current modal,
    ...
    /**
     * Build the slug for the given attribute of the current modal.
     *
    ...
    /**
     * Determines whether the modal needs slugging.
     *
     * @param string $attribute
     * @param array $config
     *
    ...
    protected function generateSuffix(string $slug, string $separator, Collection $list): string
    {
        ...
        // our modal, return the current suffix.
    ...
    protected function getExistingSlugs(string $slug, string $attribute, array $config): Collection
    {
        ...
        // use the modal scope to find similar slugs
    ...
    /**
     * Does this modal use softDeleting?
     *
     * @return bool
     */
    ...
    public static function createSlug($model, string $attribute, string $fromString, array $config = null): string
    {
        ...
        if ($config === null) {
            ...
            if ($config === null) {
                ...
                throw new \InvalidArgumentException("Argument 2 passed to SlugService::createSlug ['{$attribute}'] is not a valid slug attribute for modal {$modelClass}.");
            }
