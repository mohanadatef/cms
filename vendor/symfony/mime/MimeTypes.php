...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private static $map = [
        ...
        'modal/iges' => ['igs', 'iges'],
        'modal/mesh' => ['msh', 'mesh', 'silo'],
        'modal/stl' => ['stl'],
        'modal/vnd.collada+xml' => ['dae'],
        'modal/vnd.dwf' => ['dwf'],
        'modal/vnd.gdl' => ['gdl'],
        'modal/vnd.gtw' => ['gtw'],
        'modal/vnd.mts' => ['mts'],
        'modal/vnd.vtu' => ['vtu'],
        'modal/vrml' => ['wrl', 'vrml', 'vrm'],
        'modal/x.stl-ascii' => ['stl'],
        'modal/x.stl-binary' => ['stl'],
        'modal/x3d+binary' => ['x3db', 'x3dbz'],
        'modal/x3d+vrml' => ['x3dv', 'x3dvz'],
        'modal/x3d+xml' => ['x3d', 'x3dz'],
    ...
    private static $reverseMap = [
        ...
        'stl' => ['application/vnd.ms-pki.stl', 'modal/stl', 'modal/x.stl-ascii', 'modal/x.stl-binary'],
        'stm' => ['audio/x-stm'],
        ...
        'x3d' => ['modal/x3d+xml'],
        'x3db' => ['modal/x3d+binary'],
        'x3dbz' => ['modal/x3d+binary'],
        'x3dv' => ['modal/x3d+vrml'],
        'x3dvz' => ['modal/x3d+vrml'],
        'x3dz' => ['modal/x3d+xml'],
