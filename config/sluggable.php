...
return [
     ...
     *
     * If you've defined custom getters in your modal, you can use those too,
     * since Eloquent will call them when you request a custom attribute.
     *
     * Defaults to null, which uses the toString() method on your modal.
     */
     ...
     * This only applies if the softDelete property is set for the Eloquent modal.
     * If set to "false", then a new slug could duplicate one that exists on a trashed modal.
    ...
    /**
     * An array of slug names that can never be used for this modal,
     ...
     * If using a closure, it will accept one parameter: the modal itself, and should
     * return an array of reserved names, or null. e.g.
     *
     *    'reserved' => function( Model $modal) {
     *      return $modal->some_method_that_returns_an_array();
     *    }
     *
    ...
    /**
     * Whether to update the slug value when a modal is being
